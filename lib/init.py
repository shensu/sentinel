...
def has_galactrum_conf():
    ...
    #
    # if not, print a message stating that Galactrum must be installed and
...
def main():
    ...
    if not has_galactrum_conf():
        print("Galactrum must be installed and configured, including JSONRPC access in galactrum.conf")
        sys.exit(1)
